...
- (2026-07-20) Data migration: in packaged mode, on its next launch the app auto-renames the old default data directory and old DB file in place; it does not merge into or overwrite any path that already exists under the new name.
